...
def asrea_vr():
    return render_template("asrea-vr-application.html")


@software_bp.route("/bus-router")
def bus_router():
    return render_template("bus-router.html")


@software_bp.route("/caregiver-elderly-medicine-app")
def caregiver_app():
    return render_template("caregiver-elderly-medicine-app.html")


@software_bp.route("/chinese-idiom-game")
def idiom_game():
    return render_template("chinese-idiom-game.html")


@software_bp.route("/clearcare")
def clearcare():
    return render_template("clearcare.html")


@software_bp.route("/farm-monitoring-system")
def farm_monitoring():
    return render_template("farm-monitoring-system.html")


@software_bp.route("/hdb-resale-flat-analysis")
def hdb_analysis():
    return render_template("hdb-resale-flat-analysis.html")


@software_bp.route("/kirbyeats-food-blog")
def kirbyeats():
    return render_template("kirbyeats-food-blog.html")
...
def myems():
    return render_template("myems-employee-management-system.html")


@software_bp.route("/npng-fitness")
def npng_fitness():
    return render_template("npng-fitness.html")


@software_bp.route("/sme-electronics-store")
def sme_store():
    return render_template("sme-electronics-store.html")


@software_bp.route("/temasek-pizzas")
def temasek_pizzas():
    return render_template("temasek-pizzas.html")
